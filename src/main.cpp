...
uint256 hashGenesisBlock("0xe20ce30ba17932d97dd0d86ae9cf41fed143bb2e8d56fd3a684249325ec4b63f");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal MandarinCoin miner
...
bool CBlock::CheckBlock() const
{
    ...
    // Check timestamp
    // Mandarincoin: limit timestamp window
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MandarinCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe20ce30ba17932d97dd0d86ae9cf41fed143bb2e8d56fd3a684249325ec4b63f");
    }
...
// Genesis block
        const char* pszTimestamp = "April 03, 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		assert(block.hashMerkleRoot == uint256("0x9c40385c35fdb4461a29e74f348fc1a5ecd6028bd2780065813fc153bd1b7350"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // MandarinCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
